...
static uint32_t SercomClock = 48000000ul; // this default is changed in initClockNVIC()
...
{
  sercom->SPI.DATA.bit.DATA = data; // WRITE data into Data register
  while (sercom->SPI.INTFLAG.bit.RXC == 0)
  { // Waiting Complete Reception
  }
  return sercom->SPI.DATA.bit.DATA; // READ data
}
...
void SERCOM::initClockNVIC(void)
{
  ...
  while ((GCLK->PCHCTRL[clockId].reg & GCLK_PCHCTRL_CHEN) != GCLK_PCHCTRL_CHEN)
  {
  }
}
